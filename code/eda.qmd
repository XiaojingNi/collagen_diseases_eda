...
text =plt.text(s='Note: 0 is no thrombosis, 1 is positive thrombosis, 2 is severe thrombosis, 3 is more severe thrombosis.',y=-220,x=-13,fontsize=14)
plt.savefig("../plot/plot-01.png");
```
...
plt.bar_label(hN, labels=neglabel, fontsize=14, padding=8)
plt.bar_label(hS, labels=poslabel,fontsize=14,padding=8)

plt.legend(loc='best')
plt.axvline(0.0)
plt.title("Thrombosis diagnosis keywords",pad=10)
...
sns.heatmap(corr, annot=True, annot_kws={"size": 28 / np.sqrt(len(corr))})
plt.title("Special lab index correlation plot",pad=10)
plt.xlabel("Index")
plt.ylabel("Index")
...
plt.xticks(rotation=45)
plt.title("General lab examinatoion VS Severe thrombosis", pad=20, fontsize = 22)
...
text = plt.text(s='Note: 2 is severe thrombosis, 3 is more severe thrombosis.',y=-0.8,x=-1,fontsize=14)
